...
def cmd_tts(args: argparse.Namespace) -> None:
    ...
    voice_id = args.voice if args.voice else get_voice_id()
...
def main() -> None:
    ...
    parser_tts.add_argument(
        '--voice', '-v',
        default=None,
        help='Voice ID (default: from ELEVENLABS_VOICE_ID env)'
    )
    ...
    parser_voice.add_argument(
        '--voice', '-v',
        default=None,
        help='Target voice ID (default: from ELEVENLABS_VOICE_ID env)'
    )
